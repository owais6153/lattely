...
- Expo push delivery is implemented, but the EAS project plus APNs/FCM credentials must be configured before device delivery works. Analytics and crash reporting remain deployment choices.
