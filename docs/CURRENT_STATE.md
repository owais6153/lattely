...
- 18+ registration and legacy DOB recollection, attempt-limited email OTP verification, recovery, short access tokens, rotating hashed refresh sessions, logout, and password-confirmed deletion.
...
- Private mutual Yes/No decisions. Both Yes locks a meetup and fallback venue; transient venue failures retry automatically until the window expires; either No creates a mutual 30-day cooldown.
